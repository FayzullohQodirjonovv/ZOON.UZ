    ...
    <div className="w-[95%] m-auto">
        ...
        <div className="hidden md:flex space-x-4">
          <a href="#" className="text-pink-500 flex items-center">
            <span className="mr-1 flex text-[#C2CDDD] gap-1.5">
              <img className='' src={Location} alt="" />Город <u className='text-[#5D78FF]'>Ташкент</u>
            </span>
          </a>
      ...
      <div className="flex items-center justify-between py-4 px-4">
        <div className="text-3xl font-bold flex items-center gap-4">
          <img src={Zoonuz} alt="" className="w-24" />
        ...
        <div className="hidden md:flex items-center space-x-6">
          <button><img src={Savatcha} alt="" /></button>
          <button className="flex gap-3 font-bold text-[black]"><img src={Globus} alt="" />RU</button>
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 space-y-3 pb-4">
          ...
          <div className="flex gap-4">
            <button><img src={Globus} alt="" /></button>
            <button><img src={Soroq} alt="" /></button>
            <button><img src={Moshinlogo} alt="" /></button>
          </div>
